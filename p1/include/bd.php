...
{ 
	...
	$h1 = '3D расчет блоков';
	$description = '3D онлайн-калькулятор для точно расчета кол-ва строительных блоков. Учитывается не только стандартные блоки, но и обрезки, которые могут быть повторно использованы.';
}
