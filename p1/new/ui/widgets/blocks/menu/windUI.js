...
// основное окно
class MyUIBlocksWindMain 
{
	elMain;
	myUIBlocksWindTabs;
	myUIBlocksWindDivAbout;
	myUIBlocksWindInstruction;
	myUIBlocksWindDivAccount;
	myUIBlocksWindDivProjectLoad;
	myUIBlocksWindDivProjectSave;
	myUIBlocksWindDivProjectDemo;
		

	init()
	{
		this.myUIBlocksWindTabs = new MyUIBlocksWindTabs();
		this.myUIBlocksWindDivAbout = new MyUIBlocksWindDivAbout();
		this.myUIBlocksWindInstruction = new MyUIBlocksWindInstruction();
		this.myUIBlocksWindDivAccount = new MyUIBlocksWindDivAccount();
		this.myUIBlocksWindDivProjectLoad = new MyUIBlocksWindDivProjectLoad();
		this.myUIBlocksWindDivProjectSave = new MyUIBlocksWindDivProjectSave();
		this.myUIBlocksWindDivProjectDemo = new MyUIBlocksWindDivProjectDemo();
		this.myUIBlocksWindDivSubs = new MyUIBlocksWindDivSubs();
		
		this.myUIBlocksWindTabs.init();
		this.myUIBlocksWindDivAbout.init();
		this.myUIBlocksWindInstruction.init();
		this.myUIBlocksWindDivAccount.init();
		this.myUIBlocksWindDivProjectLoad.init();
		this.myUIBlocksWindDivProjectSave.init();
		this.myUIBlocksWindDivProjectDemo.init();
		...
		elBody.children[0].append(this.myUIBlocksWindTabs.container);		
		
		elBody.children[1].append(this.myUIBlocksWindDivAbout.container);
		elBody.children[1].append(this.myUIBlocksWindInstruction.container);
		//elBody.children[1].append(this.myUIBlocksWindDivAccount.container);
		//elBody.children[1].append(this.myUIBlocksWindDivProjectLoad.container);
		//elBody.children[1].append(this.myUIBlocksWindDivProjectSave.container);		
		elBody.children[1].append(this.myUIBlocksWindDivProjectDemo.container);
		
		this.initEvent();
		
		this.hideContainers();
		this.myUIBlocksWindDivAbout.show();
	...
	{
		this.hideContainers(); 
		this.myUIBlocksWindDivProjectLoad.container.style.display = '';
	}
	
	// скрываем все блоки к контентом
	hideContainers()
	{
		this.myUIBlocksWindDivAbout.container.style.display = 'none';
		this.myUIBlocksWindInstruction.container.style.display = 'none';
		this.myUIBlocksWindDivAccount.container.style.display = 'none';
		this.myUIBlocksWindDivProjectSave.container.style.display = 'none';
		this.myUIBlocksWindDivProjectLoad.container.style.display = 'none';
		this.myUIBlocksWindDivProjectDemo.container.style.display = 'none';
	}
	...
	enterUser({id})
	{
		this.myUIBlocksWindDivProjectSave.elInfoReg.innerHTML = '';
		this.myUIBlocksWindDivProjectLoad.elInfoReg.innerHTML = '';
	...
	{ 
		...
		for(let i = 0; i < arr.length; i++)
		{
			...
			{
				const data = await this.myUIBlocksWindDivProjectSave.clickButtonSaveProjectUI({projectId: arr[i].id});
			...
			{
				this.myUIBlocksWindDivProjectLoad.clickButtonLoadProjectUI({projectId: arr[i].id});
				this.closeWin();
			}			
			
			this.myUIBlocksWindDivProjectSave.elInfoReg.append(divBtnSave);
			this.myUIBlocksWindDivProjectLoad.elInfoReg.append(divBtnLoad);
		}		
	}
	...
	infoWaitMessage({typeInfo = 'load'})
	{
		...
		this.myUIBlocksWindDivProjectLoad.elInfoReg.innerHTML = `<div style="${cssInf}">${textInfo}</div>`;
		this.myUIBlocksWindDivProjectSave.elInfoReg.innerHTML = `<div style="${cssInf}">${textInfo}</div>`;		
	}
