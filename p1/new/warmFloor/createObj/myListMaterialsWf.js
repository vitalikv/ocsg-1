...
class MyListMaterialsWf
{
	...
	{		
		...
		this.listMat.rezba_2 = new THREE.MeshStandardMaterial({ color: 0xb87c23, map: this.listImg.rezba_1, lightMap: lightMap_1, side: THREE.DoubleSide });
		this.listMat.rezba_2.map.repeat.x = 900; 
		this.listMat.rezba_2.map.rotation = THREE.Math.degToRad( 2 );
		this.listMat.rezba_2.map.wrapS = THREE.RepeatWrapping; 
		this.listMat.rezba_2.map.wrapT = THREE.RepeatWrapping;		
		...
		this.listMat.bronz_1_edge = this.listMat.bronz_1.clone();
		this.listMat.bronz_1_edge.flatShading = true;		
	}		
