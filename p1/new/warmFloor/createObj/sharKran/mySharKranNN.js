...
class MySharKranNN
{
	...
	crGeometry({ m1, t1, r1 })
	{
		...
		const d1 = myWarmFloor.myObjsWfInit.myCalcFormObjWf.sizeRezba({size: r1, side: 'n'});
		...
		const gs = [];		
		gs[0] = this.crDetail_1({x_1, x_2, d1, x_1L, x_2L});
		gs[1] = this.crDetail_2({x_1, x_2, d1, x_1L, x_2L, w2});
		...
		gs[10] = this.crDetail_11({x_1, x_2, d1, x_1R, x_2R, w2});
		gs[11] = this.crDetail_12({x_1, x_2, d1, x_1R, x_2R});
	...
	// гайка
	crDetail_2({x_1, x_2, d1, x_1L, x_2L, w2})
	{		
