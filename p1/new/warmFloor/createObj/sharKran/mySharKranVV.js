...
class MySharKranVV
{
	...
	crGeometry({ m1, t1, r1 })
	{
		...
		const x_2L = (m1/2 - x_1)/2;
		const x_1R = 0.002;
		const x_2R = m1/2 - x_1R - x_1;
		...
		gs[10] = this.crDetail_11({x_1, d1, x_1R, x_2R, w2});
		gs[11] = this.crDetail_12({x_1, d1, x_1R, x_2R});
	...
	// гайка
	crDetail_11({x_1, d1, x_1R, x_2R, w2})
	{	
		const inf = { dlina: x_1, diameter_nr: w2, diameter_vn: d1.v+0.001, edge_nr: 6, ind: [2, 0, 0, 0] };
